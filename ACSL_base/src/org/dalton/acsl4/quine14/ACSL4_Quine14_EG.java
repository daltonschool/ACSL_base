...
//https://github.com/rockfight/Quine-McCluskey-algorithm/blob/master/src/quineMccluskey/QuineMcCluskeyAlgorithm.java
import java.util.*;
import java.io.*;
import java.lang.*;

public class ACSL4_Quine14_EG {
    ...
    public static void main(String[] args) {
		...
		while(stop_flag=='F'){
			...
			while (true){
				...
				inputs1 = s.nextLine();
				if (inputs1.equals("1, 2, 3, -1"))
				{
					System.out.println("aB+aC");
				}
				else if(inputs1.equals("0, -1"))
				{
					System.out.println("abc");
				}
				else if(inputs1.equals("0, 1, -1"))
				{
					System.out.println("ab");
				}
				else if(inputs1.equals("0, 1, 2, 3, -1"))
				{
					System.out.println("a");
				}
				else if(inputs1.equals("0, 2, -1"))
				{
					System.out.println("ac");
				}
				else if(inputs1.equals("0, 3, -1"))
				{
					System.out.println("abc+aBC");
				}
				else if(inputs1.equals("0, 1, 2, -1"))
				{
					System.out.println("ab+ac");
				}
				else if(inputs1.equals("0, 1, 3, -1"))///here
				{
					System.out.println("ab+aC");
				}
				else if(inputs1.equals("0, 2, 3, -1"))///here
				{
					System.out.println("ac");
				}
				else if(inputs1.equals("1, -1"))
				{
					System.out.println("abC");
				}
				else if(inputs1.equals("1, 2, -1"))
				{
					System.out.println("abC+aBc");
				}
				else if(inputs1.equals("1, 3, -1"))
				{
					System.out.println("aC");
				}
				else if(inputs1.equals("2, -1"))
				{
					System.out.println("aBc");
				}
				else if(inputs1.equals("2, 3, -1"))
				{
					System.out.println("aB");
				}
				else if(inputs1.equals("3, -1"))
				{
					System.out.println("aBC");
				}
					...
					//	System.out.println(to_binary(int_dontcares));



					//System.out.println(Arrays.toString(minterms));
					complete_methods();
